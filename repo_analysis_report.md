...
4. **Configuration**: Target folder paths are loaded from environment variables (e.g., `MUSIC_FOLDER_ARCHIVED`). Users need to configure these paths in their `.env` file before execution.
